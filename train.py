...
def main(params):
    ...
    for _ in range(params.max_epoch):
        ...
        while trainer.n_sentences < trainer.epoch_size:
            ...
            for lang1, lang2 in shuf_order(params.mass_steps):
            ...
            # x back-translation steps
            for lang1, lang2, lang3 in shuf_order(params.xbt_steps):
                trainer.xbt_step(lang1, lang2, lang3, params.lambda_bt)

            # ra translation steps
            for lang1, lang2, lang3 in shuf_order(params.rat_steps):
                trainer.rat_step(lang1, lang2, lang3, False, params.lambda_bt)
